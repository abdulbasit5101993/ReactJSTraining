            ...
            <div className="row">
                <div className="col-md-6 col-sm-12 col-xs-12">
                    ...
                    <div style={{fontSize: "16px"}}>
                        ...
                        { !props.user ? 
                        <button type="button" class="btn btn-warning text-uppercase p-3 text-white mr-2 mt-3 font-weight-bold" disabled title="kindly login to Add ">Add to cart</button> 
                        :
